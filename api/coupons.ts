...
import {Coupon, CouponDefinition, CouponState} from '../../src/types';
...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    if (couponsBlob && statesBlob) {
      ...
      // Return default coupons if blobs don't exist
    ...
    // Return fallback coupons on error
